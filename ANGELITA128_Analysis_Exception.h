/*
    This is part of the ANGELITA128 encryption system, the source code for the ANGELITA128 exception error class (Analysis Version)
...
/*
	...
	ANGELITA128 Analysis Exception class
